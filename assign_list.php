  ...
  <?php 
         ...
         //echo $sna;
          ...
          $page1 = ($page * 20) - 20;
            ...
            $query = "SELECT * FROM student_validation, place_of_attachment WHERE (student_validation.Stu_reg_no) = (place_of_attachment.Stu_reg_no) AND student_validation.supervisor_name = '$sna' LIMIT $page1,20";
          ...
          $c = 1;
            ...
            <td><a href="assign_student.php?regnum=<?php echo $row['Stu_reg_no'];?>" class='btn btn-info' >View Logbook</a></td>;
            </tr>
            </tbody>
                      <?php
                   $c = $c + 1;
...
<?php
for($b=1; $b<=$a; $b++) { 
  ?>    <li><a href="assign_list.php?page=<?php echo $b; ?>"><?php echo $b; ?> </a> </li> <?php
}
?>
