...
<body style="background-color:transparent; background-image:url('img/bg.jpg')">
  ...
  <?php 
          ...
          <?php
            ...
            <td><a href="co_view_logbook.php?regnum=<?php echo $row['Stu_reg_no'];?>" class='btn btn-info' >View Logbook</a></td>;
            </tr>
            </tbody>
                      <?php
...
<?php
for($b=1; $b<=$a; $b++) { 
  ?>    <li><a href="co_view_studetail.php?page=<?php echo $b; ?>"><?php echo $b; ?> </a> </li> <?php
}
?>
