    ...
    <td width="20">
         ...
         <div class="col-sm-3 col-md-2 " style="width: 334px;">
          <ul class="nav nav-pills nav-stacked" >
            ...
            <li class="active"><a href="assign_list.php">Logbook Overview</a></li>
            <li class="active"><a href="sendnotice.php"><span class="badge pull-right"><img src="img/icon-email.png" ></span>Send Message</a></li>
